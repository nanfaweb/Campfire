      ...
      <section className="w-full md:w-1/2 flex items-center justify-center p-md sm:p-xl bg-[#FFF8F2] overflow-y-auto h-full">
        <div className="w-full max-w-[440px] space-y-lg z-10 py-10">
          ...
          <div className={`relative transition-all duration-500 ease-in-out ${isLogin ? 'h-[285px]' : 'h-[440px]'}`}>
            {/* Login Form */}
            {isLogin && (
              <form className="space-y-md animate-fade-in absolute w-full top-0 left-0">
          ...
          <div className="flex flex-col gap-8">
            {/* OAuth */}
            <button className="w-full h-14 flex items-center justify-center gap-md rounded-xl border border-[#EDE0D4] bg-white hover:bg-surface-container-lowest transition-all text-on-surface font-semibold text-button shadow-sm">
